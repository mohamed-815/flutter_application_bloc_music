...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RepositoryProvider(
      create: (_) => AuthRepositoryImpl(AuthApi()),
      child: Builder(
        builder: (context) {
          final loginUseCase = LoginUseCase(context.read<AuthRepositoryImpl>());
          return BlocProvider(
        ...
        listener: (context, state) {
          if (state.status == LoginStatus.success) {
            ...
            ScaffoldMessenger.of(
              context,
            ).showSnackBar(SnackBar(content: Text('Welcome $userEmail')));
